    ...
    where TIndexType : unmanaged
{
    ...
    public VertexArrayObject(GL silkGl, BufferObject<TVertexType> verticesBufferObject, BufferObject<TIndexType> elementsBufferObject)
    {
    ...
    {
        _silkGl.VertexAttribPointer(index, count, type, false, vertexSize * (uint) sizeof(TVertexType), (void*) (offSet * sizeof(TVertexType)));
